...
import { getMediaMetadata } from '../src/get-media-metadata';
import fs from 'fs';
...
//     const result = await getMediaMetadata('./test/fixtures/IMG_5555.m4v');
...
describe('Processing images', function() {
  it('should return expected data', async () => {
    const expectedMeta = {
      file: 'cfcbb7c9-50c6-5627-aa6b-a22763653c1c',
      originalFileName: 'IMG_5553.jpg',
    ...
    const result = await getMediaMetadata('./test/fixtures/IMG_5553.jpg');
    expect(result).to.eql(expectedMeta);
  });
});
