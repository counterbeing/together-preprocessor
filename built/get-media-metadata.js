...
function getData(file) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(epIsOpen == false)) return [3 /*break*/, 2];
                    return [4 /*yield*/, ep.open()];
                case 1:
                    _a.sent();
                    epIsOpen = true;
                    _a.label = 2;
                case 2: return [4 /*yield*/, ep.readMetadata(file)
                    // ep.close()
                ];
                case 3:
                    metadata = _a.sent();
...
function default_1(filename, buffer) {
    if (buffer === void 0) { buffer = null; }
    return __awaiter(this, void 0, void 0, function () {
        var checksum, data, lat, lng, date;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    checksum = md5(buffer);
                    return [4 /*yield*/, getData(filename)];
                case 3:
                    data = _a.sent();
                    data = data["data"][0];
